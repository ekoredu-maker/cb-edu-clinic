...
(function(){
  ...
  window.addEventListener('load', function(){
    setTimeout(function(){
      ...
      const title = document.querySelector('title'); if(title) title.textContent = '🎓 학습클리닉 통합관리 V11.3';
      const hdr = document.getElementById('hdr-sub'); if(hdr) hdr.textContent = 'V11.3 · 충북종합학습클리닉 업무관리 프로그램 · Modular Edition';
      const loginSub = document.querySelector('#login-overlay p span'); if(loginSub) loginSub.textContent = 'V11.3 Stability Edition';
    }, 250);
  });
